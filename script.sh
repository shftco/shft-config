...
if [ ! -f .pre-commit-config.yaml ]; then
  curl -o .pre-commit-config.yaml https://raw.githubusercontent.com/shftco/shft-git-config/main/.pre-commit-config.yaml
fi

if [ ! -f git-conventional-commits.yaml ]; then
  curl -o git-conventional-commits.yaml https://raw.githubusercontent.com/shftco/shft-git-config/main/git-conventional-commits.yaml
fi
